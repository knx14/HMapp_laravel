...
<script>
    ...
    function showRadarChartForPoint(pointIndex) {
        ...
        try {
            ...
            const k2o = point.values?.find(v => v.parameter === 'K2O')?.value || 0;
            const cao = point.values?.find(v => v.parameter === 'CaO')?.value || 0;
            const mgo = point.values?.find(v => v.parameter === 'MgO')?.value || 0;
            ...
            chartInfo.innerHTML = `
                ...
                <small class="text-gray-500">CEC: ${cec} meq/100g</small>
            `;

...
<x-guest-layout>
    <div class="w-full max-w-md mx-auto mt-10 bg-white p-8 rounded-xl shadow-md">
        <div class="flex flex-col items-center mb-6">
            <div class="mb-2">
                <img src="/images/loginIcon" alt="ログインアイコン" class="h-16 w-16 mx-auto" />
            </div>
        ...
        @if($tab == 'login')
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-between mb-2">
                    ...
                    <button type="submit" class="flex items-center justify-center px-8 py-2 bg-blue-600 text-white font-bold rounded-md shadow hover:bg-blue-700 transition w-32">
